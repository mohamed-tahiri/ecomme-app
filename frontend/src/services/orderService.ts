...
import { Order, OrderCreationPayload } from '../types/order';
import api from './api';
...
//         return response.data;
//     } catch (error: any) {
//         console.error(`Error updating payment status for order ${orderId}:`, error.response?.data || error.message || error);
//         throw error;
//     }
// };
