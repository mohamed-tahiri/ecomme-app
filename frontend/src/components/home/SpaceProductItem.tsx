...
const SpaceProductItem: React.FC<ProductItemProps> = ({ product }) => {
    ...
    return (
        <div className="p-4">
            ...
            <div className="bg-[#f9f9f9] p-2 rounded my-3 h-[6rem] mx-2">
                <h3 className="text-[.8rem] mb-2">
                    {product.name.slice(0, 20)}
                    {product.name.length > 20 ? '...' : ''}
                </h3>
                <p className="text-[var(--heading-color)] text-[.8rem] font-semibold">
